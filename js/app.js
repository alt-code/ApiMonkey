...
function createSandboxAndTestDependency(i, outdated, projectRoot, reportPath, testCmd, config, initialTestsResult, baseVersion) 
{
    ...
    else 
    {
        ...
        async.eachSeries(depVersions, 
          ...
          function (err) 
          {
            ...
            createSandboxAndTestDependency(i + 1, outdated, projectRoot, reportPath, testCmd, config, initialTestsResult, baseVersion)
          }
        );
    }
}
